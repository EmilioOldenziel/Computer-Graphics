...
"}"));
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "Basic OpenGL framework for ACG", Q_NULLPTR));
        settingsGB->setTitle(QApplication::translate("MainWindow", "Settings", Q_NULLPTR));
        ngonLabel->setText(QApplication::translate("MainWindow", "The n in n-gon", Q_NULLPTR));
        ngonValue->setText(QApplication::translate("MainWindow", "6", Q_NULLPTR));
    } // retranslateUi
